...
typedef void(*PsyXWindowResizeHandlerFunc)(int width, int height);
...
extern PsyXWindowResizeHandlerFunc g_PsyX_OnWindowResize;
...
/* Reset stored framebuffer region on map load/scene transition. */
extern void PsyX_ResetFramebufferStore(void);
